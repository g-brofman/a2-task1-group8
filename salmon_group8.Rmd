...
```{r, fig.cap= **Figure 1.** Fish counts at Willamette Falls from 2001 - 2002 for Coho, Jack Coho, and Steelhead species. The graph represents adult passage of fish per day  }
...
ggplot (data = willamette_ts, aes(x = date, y = value))+
  geom_line()+
  labs(x = "Date", y = "Fish Count", title = "Fish counts at Willamette Falls (2001 - 2002)", subtitle = "Adult passage (fish/day)")+
...
- Steelhead experiences seasonal and cyclical patterns
...
#Trends Noticed: 1) Coho salmon had the highest seasonal peak in 2010. 2) Coho and jack-coho experience peaks in October, while Steelhead salmon experience peaks in June 3) Steelhead salmon have a longer passage period than coho and jack-coho
```
